...
public class ReservationsTab extends TabBase {
	...
	private class MyListSelectionListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			String selectedFlight = reservationList.getSelectedValue().getFlightCode();
			String selectedAirline = reservationList.getSelectedValue().getAirline();
			double cost = reservationList.getSelectedValue().getCost();
